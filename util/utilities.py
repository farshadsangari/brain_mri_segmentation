...
def get_args():
    ...
    parser.add_argument(
        "--lr", dest="lr", default=5e-4, type=float, help="Learning rate value"
    )
    ...
    parser.add_argument(
        ...
        dest="data_paths",
        type=str,
        default="./data/lgg-mri-segmentation/kaggle_3m/",
        help="Path of all images(x)",
    )

    parser.add_argument(
        "--regex-image-paths",
        dest="regex_image_paths",
        type=str,
        default="\.\/data\/lgg-mri-segmentation\/kaggle_3m\/.*.*_.*_.*\/.*_(.*_.*_.*)_(\d*)\.tif",
    ...
    parser.add_argument(
        ...
        default=True,
        type=bool,
        help="wheather to augment train data or not",
    )
